...
public class RobotAuxiliarySystem extends RobotModule {
    ...
    private static final double highTowerDroppingSpot = 40.5;
    ...
    private static final double aimCenterToDropCenterAngleLeft = Math.toRadians(-3.5);
    /** when approaching as rotating to the right */
    private static final double aimCenterToDropCenterAngleRight = Math.toRadians(9.2);
    ...
    private static final double encoderValuePerCM = 7380 / 30; // measured that 6000 encoder values where increased for a 30cm of move
